...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/15 18:13:10 by ataouaf           #+#    #+#             */
/*   Updated: 2023/06/15 18:16:13 by ataouaf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/philo.h"

static void	join_and_free_philos(t_data *info)
{
	int		i;
	int		status;
...
static void	fork_philos(t_data *info)
{
	int			i;
